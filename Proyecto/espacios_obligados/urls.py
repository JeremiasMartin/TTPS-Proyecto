...
urlpatterns = [
    ...
    path('registrar_servicio_dea/<int:dea_id>/',
         views.registrar_servicio_dea, name='registrar_servicio_dea'),
    path('listar_reparaciones_dea/<int:dea_id>/',
         views.listar_reparaciones_dea, name='listar_reparaciones_dea'),
    path('listar_mantenimientos_dea/<int:dea_id>/',
         views.listar_mantenimientos_dea, name='listar_mantenimientos_dea'),
    path('registrar_responsable/<int:sede_id>/',
         views.registrar_responsable, name='registrar_responsable'),
    path('listar_responsables/<int:sede_id>/',
         views.listar_responsables, name='listar_responsables'),
    path('editar_responsable/<int:responsable_id>/',
