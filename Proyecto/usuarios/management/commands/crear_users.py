    ...
    def handle(self, *args, **options):
        ...
        for _ in range(num_registros):
            ...
            if i < representantes_count:
                ...
                usuario.tipo_usuario = random.choice(
                    ["admin_provincial", "certificante"]
                )  # Ajusta los tipos según tus necesidades
            ...
            if usuario.tipo_usuario == "representante":
                ...
                provincias_seleccionadas = random.sample(
                    list(provincias_existentes), cantidad_provincias
                )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Se generaron y guardaron {num_registros} registros en la tabla Usuario"
            )
        )
